...
# 初始版本，car文件内容为分子分组形式，且用p3,p2,p1,e2,b表示
...
# with open(r'../data/car/1111111111111111.car', 'r') as headFile:
#     head_f = headFile.readlines()  # 读取文件内容行数
#     to_list = list('0000000001100000')  # 将文件名转为数组
#     with open(r'../data/car/0000000001100000.car', 'w') as copyfile:
#         i = 0
#         while i < 219:
#             line = head_f[i]
#             d = {'C1': '  -0.053', 'C2': '  -0.106',
...
#                  'H7': '   0.053', 'H8': '   0.053'}
#
#             if i < 39 or i > 182:  # 读取文件边界内容
#                 copyfile.write(line)
#                 i = i + 1.txt  # 步长为1
#             else:
#                 for j in range(0, len(list('0000000001100000'))):
#                     if to_list[j] == '0':
#                         for l1 in range(39 + j * 9, 44 + j * 9):
...
#                                 temp2 = head_f[l1 - 1.txt].strip().split()
#                                 if float(temp2[1.txt]) >= 10:
#                                     value1_1 = 6
#                                 else:
#                                     value1_1 = 7
#                                 # if float(temp2[8]) < 0:
...
#                                 # else:
#                                 #     value1_6 = 3
#                                 # 将甲基替换成H原子后的坐标为(15.930964400,3.877353290,2.947524220)
#                                 # H原子坐标平移
#                                 temp1[0] = 'H2'
#                                 temp1[1.txt] = '{:.9f}'.format(15.930964400 + j * 2.543)
#                                 temp1[2] = '{:.9f}'.format(3.877353290)
#                                 temp1[3] = '{:.9f}'.format(2.947524220)
#                                 copyfile.write(
#                                     temp1[0] + ' ' * value1_1 +
#                                     temp1[1.txt] + ' ' * 4 +
#                                     temp1[2] + ' ' * value_3 +
...
def create_car_file():
    ...
    for l in list:
        ...
        isExists = os.path.exists(final_path + '/' + l + '/' + l + '.car')
        if not isExists:  # 判断如果文件不存在,则创建
            file = open(final_path + '/' + l + '/' + l + '.car', 'w')
            file.close()
            print("%s 文件创建成功" % l)
        else:
            print("%s 文件已经存在")
...
def write_headFile():
    ...
    with open(r'../data/car/PolybaseP.car', 'r') as headFile:
        head_f = headFile.readlines()  # 读取文件内容行数
        # print(len(head_f))
        # print(head_f)
        # print(len(head_f))
                        ...
                        if to_list[j] == '0':
                            for l1 in range(39 + j * 9, 44 + j * 9):
                                ...
                                if l1 == 41 + j * 9:
                                    ...
                                    # H原子坐标平移
                                    temp1[0] = 'H2'
                                    temp1[1] = '{:.9f}'.format(15.930964400 + j * 2.543)
                                    temp1[2] = '{:.9f}'.format(3.877353290)
                                    temp1[3] = '{:.9f}'.format(2.947524220)
                                    copyfile.write(
                                        temp1[0] + ' ' * value1_1 +
...
# print(df)
# df.to_csv(r"./data/1.txt.car", index=False)
